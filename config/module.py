def loadModule():
	...
	coreComponents = [{"name":"usart", "type":"driver", "dependency":["USART", "sys_core","sys_dma", "sys_int", "OSAL"], "condition":'any(x in Variables.get("__PROCESSOR") for x in ["SAMV70", "SAMV71", "SAME70", "SAMS70", "PIC32CZ"])'},
					...
					{"name":"memory", "type":"driver", "dependency":["memory_dev", "sys_core", "sys_int"], "condition":'any(x in Variables.get("__PROCESSOR") for x in ["SAMV70", "SAMV71", "SAME70", "SAMS70", "PIC32CZ"])'},
                    ...
                    {"name":"i2c", "type":"driver", "dependency":["TWIHS", "sys_core", "sys_int", "OSAL"], "condition":'any(x in Variables.get("__PROCESSOR") for x in ["SAMV70", "SAMV71", "SAME70", "SAMS70", "PIC32CZ"])'},
                    {"name":"spi", "type":"driver", "dependency":["SPI", "sys_core", "sys_dma", "sys_int", "OSAL"], "condition":'any(x in Variables.get("__PROCESSOR") for x in ["SAMV70", "SAMV71", "SAME70", "SAMS70", "PIC32CZ"])'}]
