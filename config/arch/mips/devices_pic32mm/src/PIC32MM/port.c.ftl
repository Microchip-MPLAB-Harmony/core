...
*/
	...
	#define configCLEAR_TICK_TIMER_INTERRUPT() ${FREERTOS_TIM1_IFS_REG}CLR = _${FREERTOS_TIM1_IFS_REG}_T1IF_MASK
#else
...
const uint32_t ulCompareMatch = ( (configPERIPHERAL_CLOCK_HZ / portTIMER_PRESCALE) / configTICK_RATE_HZ ) - 1;
	...
	T1CONbits.TCKPS = 1;;
	PR1 = ulCompareMatch;
	${FREERTOS_TIM1_IPC_REG}bits.T1IP = configKERNEL_INTERRUPT_PRIORITY;

	/* Clear the interrupt as a starting condition. */
	${FREERTOS_TIM1_IFS_REG}bits.T1IF = 0;

	/* Enable the interrupt. */
	${FREERTOS_TIM1_IEC_REG}bits.T1IE = 1;
...
extern void *pxCurrentTCB;
	...
	${FREERTOS_CORE_SW_0_IFS_REG}CLR = _${FREERTOS_CORE_SW_0_IFS_REG}_CS0IF_MASK;

	/* Set software timer priority. */
	${FREERTOS_CORE_SW_0_IPC_REG}CLR = _${FREERTOS_CORE_SW_0_IPC_REG}_CS0IP_MASK;
	${FREERTOS_CORE_SW_0_IPC_REG}SET = ( configKERNEL_INTERRUPT_PRIORITY << _${FREERTOS_CORE_SW_0_IPC_REG}_CS0IP_POSITION );

	/* Enable software interrupt. */
	${FREERTOS_CORE_SW_0_IEC_REG}CLR = _${FREERTOS_CORE_SW_0_IEC_REG}_CS0IE_MASK;
	${FREERTOS_CORE_SW_0_IEC_REG}SET = 1 << _${FREERTOS_CORE_SW_0_IEC_REG}_CS0IE_POSITION;
