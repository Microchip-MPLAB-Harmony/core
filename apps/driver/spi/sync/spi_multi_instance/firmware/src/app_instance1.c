...
void APP_INSTANCE1_Initialize ( void )
{
    ...
    app_instance1Data.state = APP_INSTANCE1_STATE_INIT;
    ...
    switch ( app_instance1Data.state )
    {
        ...
        case APP_INSTANCE1_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                app_instance1Data.state = APP_INSTANCE1_STATE_SERVICE_TASKS;
            }
            break;
        }

        case APP_INSTANCE1_STATE_SERVICE_TASKS:
        {
