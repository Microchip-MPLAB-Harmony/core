...
#define GPIO_PB9_Toggle()            do {\
                                            PIOB_REGS->PIO_MSKR = (1<<9); \
                                            PIOB_REGS->PIO_ODSR ^= (1<<9);\
                                        } while (0)
#define GPIO_PB9_Get()               ((PIOB_REGS->PIO_PDSR >> 9) & 0x1)
#define GPIO_PB9_OutputEnable()      do {\
                                            PIOB_REGS->PIO_MSKR = (1<<9); \
										     PIOB_REGS->PIO_CFGR |=(1 << PIO_CFGR_DIR_Pos);\
                                        }while(0)
#define GPIO_PB9_InputEnable()       do { \
                                            PIOB_REGS->PIO_MSKR = (1<<9); \
										     PIOB_REGS->PIO_CFGR &= ~(1 << PIO_CFGR_DIR_Pos);\
                                        } while (0)
#define GPIO_PB9_InterruptEnable()   (PIOB_REGS->PIO_IER = (1<<9))
#define GPIO_PB9_InterruptDisable()  (PIOB_REGS->PIO_IDR = (1<<9))
...
#define GPIO_PD28_InterruptEnable()   (PIOD_REGS->PIO_IER = (1<<28))
#define GPIO_PD28_InterruptDisable()  (PIOD_REGS->PIO_IDR = (1<<28))
