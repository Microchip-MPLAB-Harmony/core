...
<#list 0..(GEN_APP_TASK_COUNT - 1) as i>
    ...
    <#if SELECT_RTOS == "FreeRTOS" && .vars[GEN_APP_TASK_ENABLE] == true>
        <#if .vars[GEN_APP_TASK_RESTRICTED_EN] == true>
            ...
            <#list 0..(GEN_APP_MAX_MPU_REG_CFG-1) as j>
                ...
                <#if .vars[MPU_REGION_EN] == true>
                    ...
                    <#if j == 0>
                        <#assign MPU_REG0_CFG = "(void*)" + .vars[MPU_REGION_BASE_ADDR] + " , " + "0x" + .vars[MPU_REGION_LEN] + " , " + .vars[MPU_REGION_ATTR]>
                    <#elseif j == 1>
                        <#assign MPU_REG1_CFG = "(void*)" + .vars[MPU_REGION_BASE_ADDR] + " , " + "0x" + .vars[MPU_REGION_LEN] + " , " + .vars[MPU_REGION_ATTR]>
                    <#else>
                        <#assign MPU_REG2_CFG = "(void*)" + .vars[MPU_REGION_BASE_ADDR] + " , " + "0x" + .vars[MPU_REGION_LEN] + " , " + .vars[MPU_REGION_ATTR]>
                    </#if>
                </#if>
            </#list>
                ...
                <#lt>       ${.vars[GEN_APP_RTOS_TASK_PRIO]}, /* uxPriority*/
                ...
                <#lt>           { ${MPU_REG2_CFG} }
                <#lt>       }
                <#lt>       <#if .vars[GEN_APP_TASK_STATIC] == true>
                <#lt>       &xTask${i}Buffer
                <#lt>       </#if>
                <#lt>   };
        ...
        <#else>
            <#if .vars[GEN_APP_TASK_STATIC] == false>
