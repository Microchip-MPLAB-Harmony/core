...
<#if SYS_DEBUG_ENABLE == true>
    <#lt>#define SYS_DEBUG_ENABLE
    <#lt>#define SYS_DEBUG_GLOBAL_ERROR_LEVEL       ${SYS_DEBUG_LEVEL}
    <#lt>#define SYS_DEBUG_PRINT_BUFFER_SIZE        ${SYS_DEBUG_PRINT_BUFFER_SIZE}
    <#lt>#define SYS_DEBUG_BUFFER_DMA_READY
...
<#if SYS_COMMAND_ENABLE == true>
    <#lt>#define SYS_CMD_ENABLE
    <#lt>#define SYS_CMD_DEVICE_MAX_INSTANCES       SYS_CONSOLE_DEVICE_MAX_INSTANCES
    <#lt>#define SYS_CMD_PRINT_BUFFER_SIZE          ${SYS_COMMAND_PRINT_BUFFER_SIZE}
    <#lt>#define SYS_CMD_BUFFER_DMA_READY
    <#if SYS_COMMAND_CONSOLE_ENABLE == true>
        <#lt>#define SYS_CMD_REMAP_SYS_CONSOLE_MESSAGE
    </#if>
    <#if SYS_COMMAND_DEBUG_ENABLE == true && SYS_DEBUG_ENABLE == true>
