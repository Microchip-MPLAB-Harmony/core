...
#define DRV_AT25_INSTANCES_NUMBER              (${DRV_AT25_NUM_INSTANCES}U)
...
#define DRV_AT25_EEPROM_FLASH_SIZE             ${EEPROM_FLASH_SIZE}U
#define DRV_AT25_EEPROM_PAGE_SIZE              ${EEPROM_PAGE_SIZE}U
