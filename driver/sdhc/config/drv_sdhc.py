def instantiateComponent(sdhcComponent, index):
	...
	sdhcMenu = sdhcComponent.createMenuSymbol(None, None)
	...
	sdhcRTOSMenu = sdhcComponent.createMenuSymbol(None, sdhcMenu)
	...
	sdhcHeaderFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSource1File = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcHeaderLocalFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcHeaderVmapFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcHeaderHostLocFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcHeaderHostFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSourceHostFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSystemDefFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSystemInitFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSystemConfFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSystemDataFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSystemObjFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSystemTaskFile = sdhcComponent.createFileSymbol(None, None)
	...
	sdhcSystemInterruptFile = sdhcComponent.createFileSymbol(None, None)
