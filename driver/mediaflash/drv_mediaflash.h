 /*******************************************************************************
  ...
  Description:
    The MEDIAFLASH driver provides a simple interface to manage the Non Volatile Flash
    Memory on Microchip microcontrollers. This file defines the interface
    definition for the MEDIAFLASH driver.
*******************************************************************************/
...
*******************************************************************************/
//DOM-IGNORE-END
#ifndef DRV_MEDIAFLASH_H
#define DRV_MEDIAFLASH_H
...
// *****************************************************************************
/* MEDIAFLASH Driver command handle.
...
typedef SYS_FS_MEDIA_BLOCK_COMMAND_HANDLE DRV_MEDIAFLASH_COMMAND_HANDLE;

// *****************************************************************************
/* MEDIAFLASH Driver Program Row Size.

  Summary:
    Specifies the MEDIAFLASH Driver Program Row Size in bytes.

  Description:
    This definition specifies the MEDIAFLASH Driver Program Row Size in bytes. This
  ...
  Remarks:
    None
*/
#define DRV_MEDIAFLASH_ROW_SIZE                            (DRV_MEDIAFLASH_HW_WRITE_SIZE)
// *****************************************************************************
/* MEDIAFLASH Driver Program Page Size.

  Summary:
    Specifies the MEDIAFLASH Driver Program Page Size in bytes.

  Description:
    This definition specifies the MEDIAFLASH Driver Program Page Size in bytes. This
    parameter is device specific and is obtained from the device specific
  ...
  Remarks:
    None
*/
#define DRV_MEDIAFLASH_PAGE_SIZE                           (DRV_MEDIAFLASH_HW_ERASE_SIZE)

// *****************************************************************************
/* MEDIAFLASH Driver Invalid Command Handle.

  Summary:
    This value defines the MEDIAFLASH Driver's Invalid Command Handle.

  Description:
    This value defines the MEDIAFLASH Driver Invalid Command Handle. This value
...
#define DRV_MEDIAFLASH_COMMAND_HANDLE_INVALID SYS_FS_MEDIA_BLOCK_COMMAND_HANDLE_INVALID

// *****************************************************************************
/* MEDIAFLASH Driver Events
   ...
   Remarks:
    ...
    calling the DRV_MEDIAFLASH_EventHandlerSet function when a request is completed.
*/

typedef enum
{
    /* Operation has been completed successfully. */
    DRV_MEDIAFLASH_EVENT_COMMAND_COMPLETE = SYS_FS_MEDIA_EVENT_BLOCK_COMMAND_COMPLETE,

    /* There was an error during the operation */
    DRV_MEDIAFLASH_EVENT_COMMAND_ERROR = SYS_FS_MEDIA_EVENT_BLOCK_COMMAND_ERROR 

} DRV_MEDIAFLASH_EVENT;

// ***********************************************************************
/* MEDIAFLASH Driver Command Status
...
{
    /*Done OK and ready */
    DRV_MEDIAFLASH_COMMAND_COMPLETED          = SYS_FS_MEDIA_COMMAND_COMPLETED,

    /*Scheduled but not started */
    DRV_MEDIAFLASH_COMMAND_QUEUED             = SYS_FS_MEDIA_COMMAND_QUEUED,

    /*Currently being in transfer */
    DRV_MEDIAFLASH_COMMAND_IN_PROGRESS        = SYS_FS_MEDIA_COMMAND_IN_PROGRESS,

    /*Unknown Command */
    DRV_MEDIAFLASH_COMMAND_ERROR_UNKNOWN      = SYS_FS_MEDIA_COMMAND_UNKNOWN,

} DRV_MEDIAFLASH_COMMAND_STATUS;
...
// *****************************************************************************
/* Driver MEDIAFLASH Module Index reference

  Summary:
    MEDIAFLASH driver index definitions

  Description:
    These constants provide MEDIAFLASH driver index definitions.

  Remarks:
    These constants should be used in place of hard-coded numeric literals.
    These values should be passed into the DRV_MEDIAFLASH_Initialize and DRV_MEDIAFLASH_Open
    routines to identify the driver instance in use.
*/

#define  DRV_MEDIAFLASH_INDEX_0      0
#define  DRV_MEDIAFLASH_INDEX_1      1

// *****************************************************************************
/* MEDIAFLASH Driver Initialization Data

  Summary:
    Defines the data required to initialize or reinitialize the MEDIAFLASH driver
...
typedef struct
{
    ...
    /* Identifies MEDIAFLASH hardware module (PLIB-level) ID */
    MEDIAFLASH_MODULE_ID       mediaflashID;

    /* Interrupt Source for Write Interrupt */
    INT_SOURCE          interruptSource;

    /* MEDIAFLASH Media start address. The driver treats this address as 
     * block 0 address for read, write and erase operations.
     * */
    uint32_t            mediaStartAddress;

    /* MEDIAFLASH Media geometry object. */
    const SYS_FS_MEDIA_GEOMETRY *mediaflashMediaGeometry;

} DRV_MEDIAFLASH_INIT;

// *****************************************************************************
/* MEDIAFLASH Driver Event Handler Function Pointer

   Summary
    Pointer to a MEDIAFLASH Driver Event handler function

   Description
    This data type defines the required function signature for the MEDIAFLASH event
  ...
  Example:
    ...
    )
    {
        ...
        switch(event)
        {
            case DRV_MEDIAFLASH_EVENT_COMMAND_COMPLETE:

                // Handle the completed buffer. 
                break;
            
            case DRV_MEDIAFLASH_EVENT_COMMAND_ERROR:
            default:
  ...
  Remarks:
    If the event is DRV_MEDIAFLASH_EVENT_COMMAND_COMPLETE, it means that the
    write or a erase operation was completed successfully. 
    
    If the event is DRV_MEDIAFLASH_EVENT_COMMAND_ERROR, it means that the scheduled
    ...
    DRV_MEDIAFLASH_EventHandlerSet function. This context handle value is
...
*/
typedef SYS_FS_MEDIA_EVENT_HANDLER DRV_MEDIAFLASH_EVENT_HANDLER;

// *****************************************************************************
// *****************************************************************************
// Section: MEDIAFLASH Driver Module Interface Routines
// *****************************************************************************
// *****************************************************************************
...
/* Function:
  ...
  Example:
    ...
    // of initializing the MEDIAFLASH Driver.
    ...
    {
        {
            ...
            .blockSize = 1,
            .numBlocks = (DRV_MEDIAFLASH_MEDIA_SIZE * 1024),
        },
        {
            // Write Region Geometry
            .blockSize = DRV_MEDIAFLASH_ROW_SIZE,
            .numBlocks = ((DRV_MEDIAFLASH_MEDIA_SIZE * 1024)/DRV_MEDIAFLASH_ROW_SIZE)
        },
        {
            // Erase Region Geometry
            .blockSize = DRV_MEDIAFLASH_PAGE_SIZE,
            .numBlocks = ((DRV_MEDIAFLASH_MEDIA_SIZE * 1024)/DRV_MEDIAFLASH_PAGE_SIZE)
        }
    };
    ...
    const DRV_MEDIAFLASH_INIT drvNvmInit =
    {
        .moduleInit.sys.powerState = SYS_MODULE_POWER_RUN_FULL,
        .mediaflashID = MEDIAFLASH_ID_0,
        .interruptSource = INT_SOURCE_FLASH_CONTROL,
        .mediaStartAddress = MEDIAFLASH_BASE_ADDRESS,
        .mediaflashMediaGeometry = &gNvmGeometry
    };

    //usage of DRV_MEDIAFLASH_INDEX_0 indicates usage of Flash-related APIs
    objectHandle = DRV_MEDIAFLASH_Initialize(DRV_MEDIAFLASH_INDEX_0, (SYS_MODULE_INIT*)&drvMEDIAFLASHInit);
  ...
  Remarks:
    This routine must be called before any other MEDIAFLASH routine is called.
    
    This routine should only be called once during system initialization
    unless DRV_MEDIAFLASH_Deinitialize is called to deinitialize the driver
    instance.
    ...
    reported by the DRV_MEDIAFLASH_Status operation. The system must use
    DRV_MEDIAFLASH_Status to find out when the driver is in the ready state.
...
/* Function:
  ...
  Description:
    Deinitializes the specified instance of the MEDIAFLASH driver module, disabling its
    operation (and any hardware). Invalidates all the internal data.
  
  Preconditions:
    Function DRV_MEDIAFLASH_Initialize should have been called before calling
    this function.
  
  Parameter:
    object -  Driver object handle, returned from the DRV_MEDIAFLASH_Initialize
              routine
  ...
  Example:
    ...
    SYS_MODULE_OBJ      object;     //  Returned from DRV_MEDIAFLASH_Initialize
    SYS_STATUS          status;
    
    DRV_MEDIAFLASH_Deinitialize(object);
    
    status = DRV_MEDIAFLASH_Status(object);
...
/* Function:
  ...
  Example:
    <code>
    SYS_MODULE_OBJ      object;     // Returned from DRV_MEDIAFLASH_Initialize
    SYS_STATUS          MEDIAFLASHStatus;
    
    MEDIAFLASHStatus = DRV_MEDIAFLASH_Status(object);
    else if (SYS_STATUS_ERROR >= MEDIAFLASHStatus)
    {
        // Handle error
    }
    </code>
...
/* Function:
  ...
  Preconditions:
    The DRV_MEDIAFLASH_Initialize routine must have been called for the specified
    MEDIAFLASH driver instance.
  
  Parameters:
    object -  Object handle for the specified driver instance (returned from
              DRV_MEDIAFLASH_Initialize)
  Returns:
    None.
...
/* Function:
  ...
  Preconditions:
    Function DRV_MEDIAFLASH_Initialize must have been called before calling this
    function.
  ...
  Returns:
    ...
    under the following circumstances:
    	- if the number of client objects allocated via DRV_MEDIAFLASH_CLIENTS_NUMBER 
          is insufficient
  ...
  Example:
    ...
    handle = DRV_MEDIAFLASH_Open(DRV_MEDIAFLASH_INDEX_0, DRV_IO_INTENT_EXCLUSIVE);
  ...
  Remarks:
    The handle returned is valid until the DRV_MEDIAFLASH_Close routine is called.
...
/* Function:
  ...
  Precondition:
    ...
    DRV_MEDIAFLASH_Open must have been called to obtain a valid opened device handle.
  ...
  Example:
    <code>
    DRV_HANDLE handle;  // Returned from DRV_MEDIAFLASH_Open

    DRV_MEDIAFLASH_Close(handle);
    </code>
  ...
  Remarks:
    ...
    calling DRV_MEDIAFLASH_Open before the caller may use the driver again. Usually
...
/* Function:
  ...
  Precondition:
    The DRV_MEDIAFLASH_Initialize routine must have been called for the specified MEDIAFLASH 
    driver instance.

    DRV_MEDIAFLASH_Open must have been called with DRV_IO_INTENT_READ or 
  ...
  Parameters:
    ...
    targetBuffer  - Buffer into which the data read from the MEDIAFLASH Flash instance
                    will be placed

    blockStart    - Start block address in MEDIAFLASH memory from where the
  ...
  Returns:
    ...
    DRV_MEDIAFLASH_COMMAND_HANDLE_INVALID if the request was not successful.
  ...
  Example:
    ...
    uint32_t blockStart = MEDIAFLASH_BASE_ADDRESS_TO_READ_FROM;
    uint32_t    nBlock = 2;
    DRV_MEDIAFLASH_COMMAND_HANDLE commandHandle;
    MY_APP_OBJ myAppObj;    

    // myMEDIAFLASHHandle is the handle returned 
    // by the DRV_MEDIAFLASH_Open function.
    
    DRV_MEDIAFLASH_Read(myMEDIAFLASHHandle, &commandHandle, &myBuffer, blockStart, nBlock);

    if(DRV_MEDIAFLASH_COMMAND_HANDLE_INVALID == commandHandle)
    {
        // Error handling here
    }
    else
...
/* Function:
  ...
  Precondition:
    ...
    DRV_MEDIAFLASH_Open() routine must have been called to obtain a valid opened device
    ...
    using the DRV_MEDIAFLASH_Erase() routine.
  ...
  Parameters:
    ...
    sourceBuffer  - The source buffer containing data to be programmed into MEDIAFLASH 
                    Flash

    blockStart    - Start block address of MEDIAFLASH Flash where the write should begin. 
  ...
  Example:
    ...
    // address should be block aligned.
    uint32_t blockStart = MEDIAFLASH_BASE_ADDRESS_TO_WRITE_TO;
    uint32_t    nBlock = 2;
    DRV_MEDIAFLASH_COMMAND_HANDLE commandHandle;
    MY_APP_OBJ myAppObj;    
    ...
    DRV_MEDIAFLASH_EventHandlerSet(myMEDIAFLASHHandle, APP_MEDIAFLASHEventHandler, (uintptr_t)&myAppObj);

    DRV_MEDIAFLASH_Write(myMEDIAFLASHHandle, &commandHandle, &myBuffer, blockStart, nBlock);
    ...
    void APP_MEDIAFLASHEventHandler(DRV_MEDIAFLASH_EVENT event, 
            DRV_MEDIAFLASH_COMMAND_HANDLE commandHandle, uintptr_t contextHandle)
    {
  ...
  Remarks:
    ...
    makes the MEDIAFLASH write operation blocking in nature.
*/
...
/* Function:
  ...
  Preconditions:
    ...
    The DRV_MEDIAFLASH_Open() routine must have been called with DRV_IO_INTENT_WRITE
  ...
  Parameters:
    ...
    blockStart    - Start block address in MEDIAFLASH memory from where the erase
                    should begin. This should be aligned on a 
                    DRV_MEDIAFLASH_PAGE_SIZE byte boundary.

    nBlock        - Total number of blocks to be erased. 
  
  Returns:
    The buffer handle is returned in the commandHandle argument. It Will be
    DRV_MEDIAFLASH_COMMAND_HANDLE_INVALID if the request was not queued.
  ...
  Example:
    ...
    DRV_MEDIAFLASH_Erase( myMEDIAFLASHHandle, &commandHandle, blockStart, nBlock );
  ...
  Remarks:
    ...
    remain pending until the cycle completes. This make the MEDIAFLASH erase operation
    blocking in nature.  
*/
...
// *****************************************************************************
/* Function:
    void DRV_MEDIAFLASH_EraseWrite
    (
        const DRV_HANDLE handle,
        DRV_MEDIAFLASH_COMMAND_HANDLE * commandHandle,
        void * sourceBuffer,
  ...
  Description:
    ...
    If the requesting client registered an event callback with the driver, the
    driver will issue a DRV_MEDIAFLASH_EVENT_COMMAND_COMPLETE event if the buffer
    was processed successfully or DRV_MEDIAFLASH_EVENT_COMMAND_ERROR event if 
  ...
  Precondition:
    ...
    The DRV_MEDIAFLASH_Open() must have been called with DRV_IO_INTENT_WRITE or 
  ...
  Parameters:
    ...
    writeBlockStart - Start block address of MEDIAFLASH Flash where the write should begin.
                    This address should be aligned on a DRV_MEDIAFLASH_ROW_SIZE byte 
                    boundary.
  ...
  Example:
    ...
    DRV_MEDIAFLASH_EraseWrite(myMEDIAFLASHHandle, &commandHandle, &myBuffer, blockStart, nBlock);
...
/* Function:
  ...
  Description:
    ...
    function may return DRV_MEDIAFLASH_COMMAND_HANDLE_INVALID in a case where the command
  ...
  Preconditions:
    The DRV_MEDIAFLASH_Initialize() routine must have been called.

    The DRV_MEDIAFLASH_Open() must have been called to obtain a valid opened device handle.
  ...
  Returns:
    A DRV_MEDIAFLASH_COMMAND_STATUS value describing the current status of the command.
    Returns DRV_MEDIAFLASH_COMMAND_HANDLE_INVALID if the client handle or the command
    handle is not valid.
  ...
  Example:
    ...
    status = DRV_MEDIAFLASH_CommandStatus(handle, commandHandle);
    if(status == DRV_MEDIAFLASH_COMMAND_COMPLETED)
    {
        // Operation Done
    }
    </code>
...
/* Function:
  ...
  Precondition:
    The DRV_MEDIAFLASH_Initialize() routine must have been called for the
    specified MEDIAFLASH driver instance.

    The DRV_MEDIAFLASH_Open() routine must have been called to obtain a valid opened device
    handle.
  ...
  Example:
    ...
    SYS_FS_MEDIA_GEOMETRY * mediaflashFlashGeometry;
    uint32_t readBlockSize, writeBlockSize, eraseBlockSize;
    uint32_t nReadBlocks, nReadRegions, totalFlashSize;

    mediaflashFlashGeometry = DRV_MEDIAFLASH_GeometryGet(mediaflashOpenHandle1);

    readBlockSize  = mediaflashFlashGeometry->geometryTable->blockSize;
    nReadBlocks = mediaflashFlashGeometry->geometryTable->numBlocks;
    nReadRegions = mediaflashFlashGeometry->numReadRegions;

    writeBlockSize  = (mediaflashFlashGeometry->geometryTable +1)->blockSize;
    eraseBlockSize  = (mediaflashFlashGeometry->geometryTable +2)->blockSize;
...
/* Function:
  ...
  Example:
    ...
    // drvMEDIAFLASHHandle is the handle returned 
    // by the DRV_MEDIAFLASH_Open function.
    
    // Client registers an event handler with driver. This is done once.

    DRV_MEDIAFLASH_EventHandlerSet(drvMEDIAFLASHHandle, APP_MEDIAFLASHEventHandler, (uintptr_t)&myAppObj);

    DRV_MEDIAFLASH_Read(drvMEDIAFLASHHandle, &commandHandle, &myBuffer, blockStart, nBlock);
    ...
    void APP_MEDIAFLASHEventHandler(DRV_MEDIAFLASH_EVENT event, 
            DRV_MEDIAFLASH_COMMAND_HANDLE handle, uintptr_t context)
    {
...
/* Function:
  ...
  Description:
    This function returns the physical attach status of the MEDIAFLASH.

  Precondition:
    The DRV_MEDIAFLASH_Initialize() routine must have been called for the specified 
    MEDIAFLASH driver instance.

    The DRV_MEDIAFLASH_Open() routine must have been called to obtain a valid opened
    device handle.
  ...
  Example:
    ...
    // The MEDIAFLASH media is always attached and so the below
    // always returns true.
    
    bool isMEDIAFLASHAttached;
    isMEDIAFLASHAttached = DRV_MEDIAFLASH_isAttached(drvMEDIAFLASHHandle);
...
/* Function:
  ...
  Summary:
    Returns the write protect status of the MEDIAFLASH.
    <p><b>Implementation:</b> Static/Dynamic</p>

  Description:
    This function returns the physical attach status of the MEDIAFLASH. This function
  ...
  Example:
    ...
    // The MEDIAFLASH media is treated as always writeable.
    bool isWriteProtected;
    isWriteProtected = DRV_MEDIAFLASH_IsWriteProtected(drvMEDIAFLASHHandle);
...
/* Function:
  ...
  Returns:
    Start address of the MEDIAFLASH Media if the handle is valid otherwise NULL.
...
#endif // #ifndef _DRV_MEDIAFLASH_H
/*******************************************************************************
 End of File
*/
