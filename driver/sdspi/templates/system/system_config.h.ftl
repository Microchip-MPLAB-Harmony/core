...
<#if (HarmonyCore.SELECT_RTOS)?? && HarmonyCore.SELECT_RTOS != "BareMetal">
    ...
    <#if (HarmonyCore.SELECT_RTOS)?? && HarmonyCore.SELECT_RTOS == "MicriumOSIII">
        <#lt>#define DRV_SDSPI_RTOS_TASK_MSG_QTY_IDX${INDEX?string}        ${DRV_SDSPI_RTOS_TASK_MSG_QTY}u
        <#lt>#define DRV_SDSPI_RTOS_TASK_TIME_QUANTA_IDX${INDEX?string}    ${DRV_SDSPI_RTOS_TASK_TIME_QUANTA}u
    </#if>
</#if>