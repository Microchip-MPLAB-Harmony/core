...
#define DRV_AT24_INSTANCES_NUMBER              (${DRV_AT24_NUM_INSTANCES}U)
...
#define DRV_AT24_EEPROM_FLASH_SIZE             (${EEPROM_FLASH_SIZE}U)
#define DRV_AT24_EEPROM_PAGE_SIZE              (${EEPROM_PAGE_SIZE}U)
