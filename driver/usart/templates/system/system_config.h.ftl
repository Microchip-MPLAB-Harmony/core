...
#define DRV_USART_XMIT_DMA_CH_IDX${INDEX?string}         SYS_DMA_CHANNEL_${DRV_USART_TX_DMA_CHANNEL}
</#if>
<#if DRV_USART_RX_DMA == true>
#define DRV_USART_RCV_DMA_CH_IDX${INDEX?string}          SYS_DMA_CHANNEL_${DRV_USART_RX_DMA_CHANNEL}
</#if>
